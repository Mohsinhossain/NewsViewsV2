package com.mohsinmonad.newsviews.drawerevent;
...
public class NavMenu extends LinearLayout {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        sldingLayoutWidth = View.MeasureSpec.getSize(widthMeasureSpec);
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (changed) {
            ...
            LinearLayout.LayoutParams menuLayoutParams = (LinearLayout.LayoutParams) menu.getLayoutParams();
